...
class MSDeformAttn(nn.Module):
    def __init__(
        ...
        :param n_points: number of sampling points per attention head per
            feature level
        """
        super().__init__()
    ...
    def _reset_parameters(self):
        ...
        if not isinstance(self.value_proj, nn.Linear):
            self.value_proj._reset_parameters()
            self.output_proj._reset_parameters()
        else:
